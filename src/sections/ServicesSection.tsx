...
const SERVICES = [
  ...
  <>
    <p>
      Earned the Unity Certified Associate: Game Developer certification,
      demonstrating foundational knowledge and practical skills in Unity-based
      game development. The certification strengthened my understanding of C#
      programming, gameplay systems, game design, physics, animation, audio,
      UI, lighting, and real-time 3D development.
    </p>

    <p>
      Through the program, I gained hands-on experience following the
      game-development workflow from concept and prototyping to development,
      iteration, and publishing, building a stronger foundation for creating
      complete game experiences with Unity.
    </p>
  </>
),
