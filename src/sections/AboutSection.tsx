...
const ABOUT_PARAGRAPHS = [
  'I’m Gnanamoorthi, a Unity 3D Game Developer focused on building engaging, interactive, and polished real-time gaming experiences.',
  'My work sits at the intersection of game development, Unity 3D, programming, gameplay systems, and interactive experiences. I enjoy turning ideas into playable experiences — from developing core gameplay mechanics and systems to creating polished, responsive, and immersive game environments.',
  'I’ve worked on real-time game development projects, building and optimizing gameplay experiences with Unity, C#, 3D assets, UI, and interactive systems, with projects published on both Google Play Store and iOS.',
];
...
export default function AboutSection() {
  return (
    ...
    >
      ...
      >
        <img src={`${DECOR_BASE}/moon.png`} alt="" className="w-[100px] sm:w-[140px] md:w-[180px]" />
      </FadeIn>
      <FadeIn
        delay={0.15}
        x={80}
      ...
      >
        <img src={`${DECOR_BASE}/group.jpg`} alt="" className="w-[130px] sm:w-[170px] md:w-[220px]" />
      </FadeIn> */}
