...
const PORTRAIT_URL = `${import.meta.env.BASE_URL}images/portrait.png`;
    ...
    >
      ...
      <div className="overflow-hidden">
        <FadeIn delay={0.15} y={40}>
          {/* vw sizes scaled from the original 14/15/16/17.5vw by the measured width
              ratio of "Hi, i'm jack" vs "Hi, i'm Gnanamoorthi" so the heading fills the
              viewport exactly like the original composition. */}
          <h1 className="hero-heading font-black uppercase tracking-tight leading-none whitespace-nowrap w-full text-center text-[10.91vw] sm:text-[11.69vw] md:text-[12.47vw] lg:text-[8.64vw] mt-6 sm:mt-4 md:-mt-1">
            Hi, i&apos;m Gnanamoorthi
          </h1>
        </FadeIn>
      </div>
      ...
      <div className="mt-auto relative z-20 flex justify-between items-end px-6 md:px-10 pb-7 sm:pb-8 md:pb-10">
        <FadeIn delay={0.35} y={20}>
          ...
          >
            I’m a Unity 3D Game Developer who enjoys turning ideas into fun, interactive experiences and bringing games to life through gameplay, code, and creativity.
          </p>
        </FadeIn>
